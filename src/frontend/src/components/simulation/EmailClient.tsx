...
import { Mail, Search, Inbox, Send, AlertCircle, Paperclip } from "lucide-react";
    ...
    <Window variant="light" title="Inbox - MailBox Browser" icon={<Mail size={16} className="text-blue-500" />} onMinimize={onMinimize} onClose={onClose} className="h-full">
      <div className="flex h-full bg-white text-gray-800">
        ...
        <div className="flex-1 flex flex-col bg-white">
          {showEmail ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-6 h-full overflow-y-auto">
              <div className="flex justify-between items-start mb-6 pb-4 border-b border-gray-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-blue-500">To: OpenClaw Agent</div>
                  </div>
                </div>
